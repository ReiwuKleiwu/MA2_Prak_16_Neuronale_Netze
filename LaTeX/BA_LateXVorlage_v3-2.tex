...
\begin{document}
  ...
  % \ref{marke}
  \input{01_grobes_mathematisches_prinzip.tex}
  \input{03_gradient_descent.tex}
  \input{04_backpropagation.tex}
  \input{05_trainings_und_testdaten.tex}
  \input{06_code.tex}
...
%     \bibitem[SW11]{SW11} Stickel-Wolf, Christine; Wolf, Joachim (2011): Wissenschaftliches Lernen und Lerntechniken. Erfolgreich studieren–-gewusst wie!. Wiesbaden: Gabler. 
      ...
      \bibitem[GR10]{GR10} Günter Daniel Rey und Karl F Wender (2010): Neuronale Netze, eine Einführung in die Grundlagen, Anwendung und Datenauswertung. 2. Auflage
      \bibitem[GBCL18]{GBCL18} Goodfellow, I., Bengio, Y., Courville, A., \& Lenz, G. (2018): "Deep Learning: das umfassende Handbuch: Grundlagen, aktuelle Verfahren und Algorithmen, neue Forschungsansätze." 1. Auflage. Frechen.
    \end{thebibliography} 
...
%     \bibitem[JH20]{JH20} Harrer, J. (2020): Künstliche Neuronale Netze.\url{https://pxldeveloper.eu/assets/docs/KuenstlicheNeuronaleNetzeJulianHarrer.pdf} (20.04.2023)
      \bibitem[HS97]{HS97} Hochreiter, S. and Schmidhuber, J. (1997): Flat minima. Neural Computation, 9(1), 1-42. \url{https://www.bioinf.jku.at/publications/older/3304.pdf} (März 1996) (abgerufen am 11.05.2023)
      ...
      \bibitem[BMDT16]{BMDT16} Bojarski, M., Del Testa, D., Dworakowski, D., Firner, B., Flepp, B., Goyal, P., ... \& Zieba, K. (2016). End to end learning for self-driving cars. arXiv preprint arXiv:1604.07316. \url{https://arxiv.org/pdf/1604.07316.pdf} (abgerufen am 18.05.2023)
      \bibitem[VTY16]{VTY16} Vasilakos, A. V., Tang, Y., \& Yao, Y. (2016). Neural networks for computer-aided diagnosis in medicine: a review. Neurocomputing, 216, 700-708. \url{https://www.sciencedirect.com/science/article/pii/S0925231216308815} (abgerufen am 19.05.2023)
      \bibitem[YHCE18]{YHCE18} Ying, R., He, R., Chen, K., Eksombatchai, P., Hamilton, W. L., \& Leskovec, J. (2018, July). Graph convolutional neural networks for web-scale recommender systems. In Proceedings of the 24th ACM SIGKDD international conference on knowledge discovery \& data mining (pp. 974-983). \url{https://dl.acm.org/doi/pdf/10.1145/3219819.3219890} (abgerufen am 18.05.2023)
      \bibitem[WCQS18]{WCQS18} Wang, T., Chen, Y., Qiao, M., \& Snoussi, H. (2018). A fast and robust convolutional neural network-based defect detection model in product quality control. The International Journal of Advanced Manufacturing Technology, 94, 3465-3471. \url{https://link.springer.com/article/10.1007/s00170-017-0882-0} (abgerufen am 20.05.2023)
      \bibitem[CJLV15]{CJLV15} Chan, W., Jaitly, N., Le, Q. V., \& Vinyals, O. (2015). Listen, attend and spell. arXiv preprint arXiv:1508.01211. \url{https://arxiv.org/pdf/1508.01211.pdf} (abgerufen am 27.05.2023)
      \bibitem[KSH17]{KSH17} Krizhevsky, A., Sutskever, I., \& Hinton, G. E. (2017). Imagenet classification with deep convolutional neural networks. Communications of the ACM, 60(6), 84-90. \url{https://dl.acm.org/doi/pdf/10.1145/3065386} (abgerufen am 03.06.2023)
      \bibitem[SP18]{SP18} https://media.springernature.com/lw685/springer-static/image/chp%3A10.1007%2F978-3-662-56741-8_35/MediaObjects/154546_4_De_35_Fig1_HTML.png (abgerufen am 03.06.2023)
    \end{thebibliography} 
  ...
  % \input{99_erklaerungSelbstaenigeVerfassung.tex}
