\begin{tcolorbox}[title={Inhalt}]
  Die Einleitung umfasst folgende Elemente:
  \begin{quotation}
      Dieses Kapitel liefert einen Einstieg in Neuronale Netze und vermittelt die Idee dahinter. An Beispielen sollen Anwendungsfälle anschaulicht gemacht werden.
