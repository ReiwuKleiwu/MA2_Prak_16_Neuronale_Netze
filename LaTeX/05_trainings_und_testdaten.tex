...
\thispagestyle{empty}
\section{Trainieren und Testen}\label{sec:trainierentesten}   
...
\subsubsection{Validierungsdate}
...
Bei einer nur geringen Anzahl an Trainingsdaten werden nicht genug Anpassungen durchgeführt, sodass ein Lernen nach Mustern möglich wäre. Die Folge davon ist, dass die Trainingsdaten auswendig gelernt werden.
