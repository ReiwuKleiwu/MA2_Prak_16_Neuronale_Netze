\chapter{Backpropagation}\label{Backpropagation}   
...
\section{Wie lernen Neuronale Netze?}\label{}

\section{Grundidee Backpropagation}\label{}
\subsection{Fehlerrückführung}\label{Abs.1}
  %\input{}
  TEXT FOLGT...

\subsection{Methode mit Matrixenmultiplikation}\label{Abs.2}
  %\input{}
  TEXT FOLGT...

\subsection{Foward / Backward Phase erklären}\label{Abs.3}
  %\input{}
  TEXT FOLGT...

\section{Fehlerfunktion finden}\label{}

\section{Gewichtsanpassung (Maybe)}\label{}